...
router.get("/user-appointment-informations", requireUser, errorHandler(appointmentInformations), sendIfUpdated)

// CREATE OR UPDATE AN APPOINTMENT COMING FROM AN USER
router.put("/user-appointment-saving", requireUser, errorHandler(userAppointmentSaving))

// USER DELETE AN APPOINTMENT
router.delete("/delete-appointment/:_id", requireUser, errorHandler(deleteAppointment))
